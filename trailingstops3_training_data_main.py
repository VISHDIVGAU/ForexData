...
from currency_conversion import TrailingStopsTrainingData3
...
def main():
    ...
    data= TrailingStopsTrainingData3()
    data.trailing_forex_trainingdata3() # collect vector of max, min, mean, vol, fd, return of different currency pairs in _agg tables for a period of 10 hours aggregated over a window of six minutes
